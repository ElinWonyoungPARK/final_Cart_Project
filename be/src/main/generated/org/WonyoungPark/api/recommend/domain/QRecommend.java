package org.WonyoungPark.api.recommend.domain;
...
public class QRecommend extends EntityPathBase<Recommend> {
    ...
    private static final long serialVersionUID = 1630794480L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QRecommend recommend = new QRecommend("recommend");

    public final org.WonyoungPark.api.analysis.domain.QAnalysis analysis;
    ...
    public QRecommend(Class<? extends Recommend> type, PathMetadata metadata, PathInits inits) {
        ...
        this.analysis = inits.isInitialized("analysis") ? new org.WonyoungPark.api.analysis.domain.QAnalysis(forProperty("analysis"), inits.get("analysis")) : null;
    }
