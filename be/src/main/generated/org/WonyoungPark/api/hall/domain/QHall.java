package org.WonyoungPark.api.hall.domain;
...
public class QHall extends EntityPathBase<Hall> {
    ...
    private static final long serialVersionUID = 1277237274L;

    public static final QHall hall = new QHall("hall");

    public final ListPath<org.WonyoungPark.api.exhibition.domain.Exhbn, org.WonyoungPark.api.exhibition.domain.QExhbn> exhbnList = this.<org.WonyoungPark.api.exhibition.domain.Exhbn, org.WonyoungPark.api.exhibition.domain.QExhbn>createList("exhbnList", org.WonyoungPark.api.exhibition.domain.Exhbn.class, org.WonyoungPark.api.exhibition.domain.QExhbn.class, PathInits.DIRECT2);
